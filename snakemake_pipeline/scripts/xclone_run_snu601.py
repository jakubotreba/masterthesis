...
gene_expr_matrix = snakemake.input[3]
...
dataset = "SNU601"
out_dir = "results/output_snu601/xclone/"
#gene_expr_matrix = pd.read_table("../tnbc1_data/GSM4476486_combined_UMIcount_CellTypes_TNBC1.txt", sep="\t")
